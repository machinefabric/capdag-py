...
# TEST0056: is_empty returns true for empty response, false for non-empty
def test_0056_is_empty():
...
# TEST0057: size returns exact byte count for all content types
def test_0057_size():
